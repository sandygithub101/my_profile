...
const appCss = "/assets/styles-C8tBiNEI.css";
...
const Route$5 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of a software engineer crafting intuitive, beautifully engineered products." },
      { name: "author", content: "Aaabad Ahmed" },
      { property: "og:title", content: "Aaabad Ahmed — Software Engineer" },
      { property: "og:description", content: "Portfolio of a software engineer crafting intuitive, beautifully engineered products." },
...
const $$splitComponentImporter$4 = () => import("./tools-BLOIJq7E.js");
const Route$4 = createFileRoute("/tools")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$3 = () => import("./services-CtKIspf3.js");
const Route$3 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Web design, development and product engineering services."
    }, {
      property: "og:title",
      content: "Services — Sandeep kumar"
    }, {
      property: "og:description",
      content: "Web design, development and product engineering services."
    }]
...
const $$splitComponentImporter$2 = () => import("./projects-DddGmMcg.js");
const Route$2 = createFileRoute("/projects")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A selection of recent web and template projects."
    }, {
      property: "og:title",
      content: "Projects — Sandeep kumar"
    }, {
      property: "og:description",
      content: "Recent web and template projects."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./blog-DsXkK7_f.js");
const Route$1 = createFileRoute("/blog")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Notes on design, web development and the craft of building products."
    }, {
      property: "og:title",
      content: "Design Thoughts — Sandeep kumar"
    }, {
      property: "og:description",
      content: "Notes on design, web development and the craft of building products."
    }]
...
const Dribbble = createLucideIcon("dribbble", __iconNode$7);
const __iconNode$6 = [
  [
    "path",
    {
...
const items = [
  ...
  { to: "/blog", icon: SquarePen, label: "Blog" }
];
function PillNav() {
  const pathname = useRouterState({ select: (s) => s.location.pathname });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "fixed top-6 left-1/2 -translate-x-1/2 z-50 pill-nav flex items-center gap-1", children: items.map(({ to, icon: Icon2, label }) => {
...
const portrait = "/assets/profile_img-32djQaBR.png";
function ProfileCard() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "lg:sticky lg:top-32 self-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-surface text-surface-foreground rounded-3xl p-6 shadow-[var(--shadow-card)] max-w-sm mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative rounded-2xl overflow-hidden aspect-[3/4]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: portrait,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mt-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold tracking-tight", children: "Sandeep Kumar" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-center text-sm text-neutral-500 leading-relaxed", children: "A Fullstack Engineer who has developed countless innovative solutions." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex justify-center gap-4 text-brand-orange", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "Dribbble", className: "hover:opacity-70 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dribbble, { className: "w-5 h-5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "Twitter", className: "hover:opacity-70 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Twitter, { className: "w-5 h-5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "Instagram", className: "hover:opacity-70 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { className: "w-5 h-5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "YouTube", className: "hover:opacity-70 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { className: "w-5 h-5" }) })
    ] })
  ] }) });
}
function PageLayout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PillNav, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 pt-32 pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-[minmax(0,360px)_1fr] gap-12 lg:gap-16", children: [
...
function DisplayHeading({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "display-heading", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block", children: line1 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block faded", children: line2 })
  ] });
}
const $$splitComponentImporter = () => import("./index-uz9uraml.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Software engineer crafting intuitive products and beautifully engineered web experiences."
    }, {
      property: "og:title",
      content: "Sandeep kumar — Fullstack Engineer"
    }, {
      property: "og:description",
...
const ToolsRoute = Route$4.update({
  id: "/tools",
  path: "/tools",
